...
## Plot the time evolution of the daily General CPI Inflation
...
plt.legend(title = "Division", bbox_to_anchor = (1.02, 0.7), loc = "upper left")
plt.grid(True)
plt.tight_layout()
...
if is_last_thursday(current_date):
    ...
    # Plot the time evolution of the monthly General CPI Inflation
