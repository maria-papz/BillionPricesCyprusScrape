...
urls = pd.read_csv("ECOICOPv2/Datasets/Daily-Scraping-Errors-IterationA.csv")
...
daily_errors.to_csv("ECOICOPv2/Datasets/Daily-Scraping-Errors-IterationB.csv", index=False)
